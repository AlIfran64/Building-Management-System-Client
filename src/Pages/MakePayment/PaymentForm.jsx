...
const PaymentForm = () => {
  ...
  return (
    <div className='px-4 md:px-8 py-6 bg-white dark:bg-[#121212] min-h-screen text-gray-800 dark:text-gray-300'>
      ...
      <form onSubmit={handleSubmit} className='space-y-4 rounded-xl shadow-md bg-white dark:bg-[#1e1e1e] p-6 w-full mx-auto'>
        <CardElement
        ...
        <div className="space-y-2">
          <input
            ...
            className="input input-bordered w-full bg-white dark:bg-[#2b2b2b] text-black dark:text-white"
          />
          <button type="button" onClick={handleApplyCoupon} className="btn btn-outline btn-info w-full">
            Apply Coupon
          </button>
        </div>
