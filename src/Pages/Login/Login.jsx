...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f9f9f9] dark:bg-[#1e1e1f] flex flex-col items-center justify-center px-4">
      ...
      <div className="bg-white dark:bg-[#2c2c2f] shadow-xl rounded p-10 w-full max-w-md">
        ...
        <p className="text-sm text-center text-gray-500 dark:text-gray-400 mt-1 mb-6">
          Securely manage your apartment profile and explore exclusive features.
        </p>
